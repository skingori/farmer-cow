...
<?php
include '../connection/db.php';
$result = mysqli_query($con,"SELECT COUNT(0) FROM animal_table");
...
$a=mysqli_query($con,"select SUM(Milk_Quantity ) AS price FROM milk_table");
$fetch1=mysqli_fetch_array($a);
//2
$b=mysqli_query($con,"select SUM(Feeds_Cost ) AS feeds FROM feeds_table");
$fetch2=mysqli_fetch_array($b);
//3
$c=mysqli_query($con,"select SUM(Animal_feeds_cost) AS cost FROM animal_feeds_table");
$fetch3=mysqli_fetch_array($c);
//4
$d=mysqli_query($con,"select SUM(Milk_Price) AS cost FROM milk_table");
            ...
            <div class="info-container">
                ...
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        ...
                        <li><a href="add-user.php"><i class="material-icons">perm_identity</i>Add User</a></li>
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="assign.php"><i class="fa fa-link"> Asign to Animal</i></a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        ...
                        <li>
                            <a href="feedreport.php"><i class="fa fa-file"> Feeds Cost</i></a>
                        </li>
                    </ul>
                </li>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-pink hover-expand-effect">
                    <div class="icon">
                        <a href="assign.php" ><i class="fa fa-map-marker"></i></a>
                    </div>
                    <div class="content">
                        <div class="text">MY COWS</div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-cyan hover-expand-effect">
                    <div class="icon">
                        <a href="milk.php" ><i class="fa fa-bitbucket"></i></a>
                    </div>
                    <div class="content">
                        <div class="text">TOTAL MILK<small>&nbsp;(ltrs)</small></div>
                        <div class="number count-to" data-from="0" data-to="<?php echo $fetch1[price];?>" data-speed="1000" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-light-green hover-expand-effect">
                    <div class="icon">
                        <a href="feeds.php" ><i class="fa fa-tachometer"></i></a>
                    </div>
                    <div class="content">
                        <div class="text">FEEDS COST</div>
                        <div class="number count-to" data-from="0" data-to="<?php echo $fetch2[feeds];?>" data-speed="1000" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-orange hover-expand-effect">
                    <div class="icon">
                        <a href="costs.php" ><i class="fa fa-usd" aria-hidden="true"></i></a>
                    </div>
                    <div class="content">
                        <div class="text">FEEDING COST</div>
                        <div class="number count-to" data-from="0" data-to="<?php echo $fetch3[cost];?>" data-speed="1000" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="card">
                    <div class="body breadcrumb-bg-red">
                        ...
                        <ul class="dashboard-stat-list">
                            ...
                            <li>
                                TOTAL MILK COST
                                <span class="pull-right"><b></b><?php echo $fetch4[cost];?> <small>kshs</small></span>
                            </li>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="card">
                    <div class="body breadcrumb-bg-light-blue">
                        <div class="sparkline" data-type="line" data-spot-Radius="4" data-highlight-Spot-Color="rgb(233, 30, 99)" data-highlight-Line-Color="#fff"
                             data-min-Spot-Color="rgb(255,255,255)" data-max-Spot-Color="rgb(255,255,255)" data-spot-Color="rgb(255,255,255)"
                             data-offset="90" data-width="100%" data-height="92px" data-line-Width="2" data-line-Color="rgba(255,255,255,0.7)"
                             data-fill-Color="rgba(0, 188, 212, 0)">
                        ...
                        <ul class="dashboard-stat-list">
                            ...
                            <li>
                                TOTAL FEEDING COST
                                <span class="pull-right"><b></b> <?php echo $fetch3[cost];?><small>Kshs</small></span>
                            </li>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="card">
                    <div class="body breadcrumb-bg-light-green">
                        <div class="sparkline" data-type="line" data-spot-Radius="4" data-highlight-Spot-Color="rgb(233, 30, 99)" data-highlight-Line-Color="#fff"
                             data-min-Spot-Color="rgb(255,255,255)" data-max-Spot-Color="rgb(255,255,255)" data-spot-Color="rgb(255,255,255)"
                             data-offset="90" data-width="100%" data-height="92px" data-line-Width="2" data-line-Color="rgba(255,255,255,0.7)"
                             data-fill-Color="rgba(0, 188, 212, 0)">
                        ...
                        <ul class="dashboard-stat-list">
                            ...
                            <li>
                                TOTAL MILK
                                <span class="pull-right"><b><?php echo $fetch1[price];?></b> <small>Ltrs</small></span>
                            </li>
